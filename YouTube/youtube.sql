...
DROP SEQUENCE SEQ_VIDEO_LIKE;
 ...
 CREATE TABLE VIDEO(
    ...
    VIDEO_VIEWS NUMBER DEFAULT 0, --하나씩 추가 되니까 0으로 
...
--
---- 채널 수정
UPDATE CHANNEL SET CHANNEL_NAME = '주황색 ORANGE MUSIC' WHERE CHANNEL_CODE = 4;
COMMIT;
--
---- 채널삭제
DELETE FROM CHANNEL;
--
----내 채널 보기
--SELECT CHANNEL_NAME, MEMBER_NICKNAME FROM CHANNEL
--JOIN MEMBER USING (MEMBER_ID) WHERE MEMBER_ID = 'user1';
