...
SELECT STUDENT_NO, STUDENT_NAME,  AVG(NVL(POINT,0))
FROM TB_STUDENT S
JOIN TB_CLASS C ON (C.DEPARTMENT_NO = T.DEPARTMENT_NO)
JOIN TB_GRADE G ON (G.DEPARTMENT_NO = DEPARTMENT_NO)
JOIN TB_DEPARTMENT T ON (T.department_no = C.department_no)
